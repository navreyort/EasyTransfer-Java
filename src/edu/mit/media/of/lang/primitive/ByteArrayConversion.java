...
public class ByteArrayConversion {
	...
	/* ========================= */
	public static byte[] toByta(@NonNull Object data){
		if(data instanceof Byte){
			return ByteArrayConversion.toByta(((Byte)data).byteValue());
		}
		else if(data instanceof Short){
			return ByteArrayConversion.toByta(((Short)data).shortValue());
		}
		else if(data instanceof Integer){
			return ByteArrayConversion.toByta(((Integer)data).intValue());
		}
		else if(data instanceof Long){
			return ByteArrayConversion.toByta(((Long)data).longValue());
		}
		else if(data instanceof Character){
			return ByteArrayConversion.toByta(((Character)data).charValue());
		}
		else if(data instanceof Boolean){
			return ByteArrayConversion.toByta(((Boolean)data).booleanValue());
		}
		return null;
	}
